...
object ScalaSparkGraphx {
  ...
  def main(args: Array[String]) {
    ...
    // any invocation to the RDD operation then your resultant RDD will
    // contain modified collection.
    val subjects: RDD[(VertexId, (String))] =
      sparkCtx.parallelize(Array((1L, ("English")), (2L, ("Math")), (3L, ("Science"))))
    // Define Vertices/Nodes for Teachers
    val teachers: RDD[(VertexId, (String))] =
      sparkCtx.parallelize(Array((4L, ("Leena")), (5L, ("Kate")), (6L, ("Mary"))))
    // Define Vertices/Nodes for Students
    val students: RDD[(VertexId, (String))] =
      sparkCtx.parallelize(Array((7L, ("Adam")), (8L, ("Joseph")), (9L, ("Jessica")),
        (10L, ("Ram")), (11L, ("brooks")), (12L, ("Camily"))))
    ...
    val subjectsVSteachers: RDD[Edge[String]] =
      sparkCtx.parallelize(Array(Edge(4L, 1L, "teaches"), Edge(5L, 2L,
        "teaches"), Edge(6L, 3L, "teaches")))
    // Define Edges/Relationships between Subject vs Students
    val subjectsVSstudents: RDD[Edge[String]] = sparkCtx.parallelize(
      Array(Edge(7L, 3L, "Enrolled"), Edge(8L, 3L, "Enrolled"), Edge(9L, 2L,
        "Enrolled"), Edge(10L, 2L, "Enrolled"), Edge(11L, 1L, "Enrolled"),
    ...
    // EdgeTriplet represents an edge along with the vertex
    // attributes of its neighboring vertices.triplets
    graph.triplets.filter(f => f.dstAttr.equalsIgnoreCase("Math")).collect().
      foreach(println)
    sparkCtx.stop()
  }
}
